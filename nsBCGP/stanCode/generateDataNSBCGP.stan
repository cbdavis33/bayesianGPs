functions{
  ...
  // REWRITE THIS FOR SIGMA^2(X), THE NON-CONSTANT VARIANCE FUNCTION  
...
data {
  ...
  vector<lower=0, upper=1>[D] rhoG;  // correlation parameters for log GP for the variance function
